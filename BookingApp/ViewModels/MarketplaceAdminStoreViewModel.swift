//
//  MarketplaceAdminStoreViewModel.swift
//  SlotBook
//
//  Legacy marketplace “services” admin calendar (still used by AdminItemCalendarView).
//  Primary owner hub is now badminton AdminStoreViewModel.
//
...
@Observable
@MainActor
final class MarketplaceAdminStoreViewModel {
